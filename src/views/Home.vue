...
export default {
  ...
  methods: {
    ...
    refrescar() {
      this.fetchPlanetas(); // obtener nuevas imagenes
    },
  },
};
</script>
...
<template>
  <main>
    <MiButton icon="pi pi-refresh" @click="refrescar"></MiButton>
    <MiButton icon="pi pi-reddit">
      <RouterLink to="/masinfo">Ver más</RouterLink>
    </MiButton>
    <DataTable :value="planetas" class="custom-table">
      ...
      <Column field="date" header="Fecha foto"></Column>
